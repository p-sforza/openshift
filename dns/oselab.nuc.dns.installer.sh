...
${DOMAIN_OSE_APP} IN SOA master.${DOMAIN_OSE_APP}.  root.${DOMAIN_OSE_APP}.  (
  2011112904  ;  serial
  60  ;  refresh (1 minute)
  15  ;  retry (15 seconds)
  ...
  NS master.${DOMAIN_OSE_APP}.
\$ORIGIN ${DOMAIN_OSE_APP}.
test A ${LOADBALANCER1_IP}
* A ${LOADBALANCER1_IP}"  >  /var/named/zones/${DOMAIN_OSE_APP}.db
